...
<section class="guide-intro-section">
    <div class="container">
        ...
        <div class="guide-intro-cards flex">
            <div class="card">
                <div class="guide-intro-image1"></div>
                <div class="guide-intro-description">
                    <p class="text ff-noto none">紫潔</p>
                    <p class="text ff-noto">
                        -具海外高山攀登經驗<br>
                        -具野地救援能力<br>
                        -具背負25KG以上能力<br>
...
<section class="other-activity-section">
    <div class="container">
        ...
        <div class="other-activity-image "></div>
        <div class="other-activity-image none"></div>
        <div class="other-activity-image none"></div>
    </div>
</section>
...
<section class="comment-section">
    <div class="container">
        ...
        <div class="comment-card">
            ...
            <div class="bottomBox">
                <p class="text ff-airbnb">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim ea quasi et id, animi numquam laudantium consequuntur nemo voluptas dolorum voluptatibus maiores libero, tempore quia facilis amet rem culpa tenetur. 
                </p>
            </div>
